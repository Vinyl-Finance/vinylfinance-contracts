...
contract Treasury is ContractGuard {
    ...
    // NOTE: Not excluding tomb pools
    // // exclusions from total supply
    // address[] public excludedFromTotalSupply = [
    //     address(0x363d09adBf48E3e27A38C43F0f322551426ebaF6), // TombGenesisPool
    //     address(0x076b650cd39CFFE75c41BC94B4D803BD232c0D81) // TombRewardPool
    // ];
    ...
    function initialize(
        ...
        tombPriceOne = 10**18; // 1 tomb with 18 decimals
        tombPriceCeiling = tombPriceOne.mul(101).div(100);

        // Dynamic max expansion percent
        supplyTiers = [0 ether, 100000 ether, 200000 ether, 400000 ether, 600000 ether, 1000000 ether, 1500000 ether, 2000000 ether, 5000000 ether];
    ...
    function buyBonds(uint256 _tombAmount, uint256 targetPrice) external onlyOneBlock checkCondition checkOperator {
        ...
        require(
            tombPrice < tombPriceOne, // price < 1 TOMB
